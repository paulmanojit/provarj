...
public class LigsitePocketPredictionLoader extends PocketPredictionLoader {
    private static final String fileSuffix = ".pdb_pocket_r.pdb";

    public LigsitePocketPredictionLoader(String parentDirectoryPath) {
